...
public:
  ...
  cell_properties();
  cell_properties(double, Point<2> *, double *, Point<2> *, Point<2> *,
                  double *, double *, double *, double *, double *, double *,
                  Point<2> *, double *, double *, double *);
  cell_properties(const cell_properties &);
  ~cell_properties();

  // Reinitialize
  void reinit(double, Point<2> *, double *, Point<2> *, Point<2> *, double *,
              double *, double *, double *, double *, double *, Point<2> *,
