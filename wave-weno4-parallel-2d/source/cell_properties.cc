...
cell_properties::cell_properties(
    double _area, Point<2> _cell_quadrature_points[], double *_jxws,
    Point<2> _face_quadrature_points1[], Point<2> _face_quadrature_points2[],
    double *_face_jxws_1, double *_face_jxws_2, double *_face_normal_x1,
    double *_face_normal_x2, double *_face_normal_y1, double *_face_normal_y2,
    Point<2> _face_center_quadrature_points[], double *_face_center_normal_x,
...
double cell_properties::measure() const { return area; }
...
Point<2>
cell_properties::face_quadrature_point1(unsigned int face_index) const {
...
Point<2>
cell_properties::face_quadrature_point2(unsigned int face_index) const {
...
Point<2>
cell_properties::face_center_quadrature_point(unsigned int face_index) const {
...
double cell_properties::h() const { return h_size; }
